...
function weatherDetails(info) {
    ...
    if (id < 300 && id > 200) {
        ...
        iconElement.src = "thunderstorm.svg"
    }
    else if (id < 400 && id > 300) {
        iconElement.src = "cloud-solid.svg"
    }
    else if (id < 600 && id > 500) {
        iconElement.src = "rain.svg"
    }
    else if (id < 700 && id > 600) {
        iconElement.src = "snow.svg"
    }
    else if (id < 800 && id > 700) {
        iconElement.src = "clouds.svg"
    }
    else if (id == 800) {
        iconElement.src = "cloud-sun-solid.svg"
    }
}
